...
/***/ function(module, exports, __webpack_require__) {
	...
	var Putio = exports.Putio = (function () {
	  ...
	  _createClass(Putio, [{
	    ...
	    key: 'apiURI',
	    value: function apiURI(path) {
	      var query = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	      return URI(ENDPOINT).query(query).path(path).toString();
	    }
	  }, {
	    key: 'generateLoginURI',
	    value: function generateLoginURI() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	  ...
	  if (true) {
	    // Node
	    module.exports = factory(__webpack_require__(6), __webpack_require__(8), __webpack_require__(9));
